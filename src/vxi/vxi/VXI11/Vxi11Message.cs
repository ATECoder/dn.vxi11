...
/// <summary>   A collection of VXI-11 messages. </summary>
/// <remarks>
...
internal enum Vxi11Message
{
    ...
    [Description( "Abort Channel: device aborts an in-progress call." )]
    DeviceAbortProcedure = 1,
    ...
    [Description( "Core channel: opens a link to a device and returns a Device Link codec" )]
    CreateLinkProcedure = 10,
    ...
    [Description( "Core channel: send a message to the device." )]
    DeviceWriteProcedure = 11,
    ...
    [Description( "Core channel: device enables/disables sending of service requests." )]
    DeviceEnableSrqProcedure = 20,

    /// <summary>  Core channel: device executes a command. <para>
    /// Renamed from <c>device_docmd_1 = 22</c>. </para> </summary>
    [Description( "Core channel: device executes a command." )]
    DeviceDoCommandProcedure = 22,
    ...
    [Description( "Core channel: closes a link to a device." )]
    ...
    CreateInterruptChannelProcedure = 25,

    /// <summary>  Core channel: device destroys interrupt channel. <para>
    /// Renamed from <c>destroy_intr_chan_1 = 26</c>. </para> </summary>
    [Description( "Core channel: device destroys interrupt channel." )]
    DestroyInterruptChannelProcedure = 26,
    ...
    [Description( "Interrupt Channel: used by device to send a service request." )]
    DeviceInterruptSrqProcedure = 30,
