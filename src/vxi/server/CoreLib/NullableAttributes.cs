...
internal sealed class MemberNotNullAttribute : Attribute
{
    ...
    /// <param name="members">  The list of field and property members that are promised to be not-
    ///                         null. </param>
...
{
    /// <summary>
    /// Initializes the attribute with the specified return value condition and a field or property
    /// member.
    /// </summary>
    ...
    /// <summary>
    /// Initializes the attribute with the specified return value condition and list of field and
    /// property members.
    /// </summary>
    /// <param name="returnValue">  The return value condition. If the method returns this value, the
    ///                             associated parameter will not be null. </param>
    /// <param name="members">      The list of field and property members that are promised to be
    ///                             not-null. </param>
