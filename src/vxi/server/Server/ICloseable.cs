...
internal interface ICloseable : IDisposable
{
    ...
    /// The <see cref="Vxi11Server.Dispose(bool)"/> accumulates and throws an aggregate exception </item><item>
    /// The <see cref="IDisposable.Dispose()"/> method throws the aggregate exception from <see cref="Vxi11Server.Dispose(bool)"/>. </item></list>
    /// </remarks>
    void Close();
